...
class Connection:
    ...
    def __gt__(self, other):
        """Defines a consistent ordering for connections in the priority queue."""
...
class Drone:
    def __init__(self, d_id: str):
        self.id = d_id
        self.path: List[Tuple[int, Zone | Connection]] = []  # e.g., [(1, roof1), (2, roof2)]
